...
export default function Twirl() {
            ...
            for (let y = 0; y < 480; y++) {
                for (let x = 0; x < 640; x++) {
                    ...
                    if (frame2.data[index] == 0 || frame2.data[index + 1] == 0 || frame2.data[index + 2] == 0 || frame2.data[index + 3] == 0) {
                        ...
                        while ((frame2.data[tempIndex1] == 0 || frame2.data[tempIndex1 + 1] == 0 || frame2.data[tempIndex1 + 2] == 0 || frame2.data[tempIndex1 + 3] == 0))
                            tempIndex1 -= 4
                        while ((frame2.data[tempIndex2] == 0 || frame2.data[tempIndex2 + 1] == 0 || frame2.data[tempIndex2 + 2] == 0 || frame2.data[tempIndex2 + 3] == 0))
                            tempIndex2 += 4
    ...
    return (
        <div >
            <canvas id={`twirl`} width="640" height="480" ref={cloneRef} ></canvas>
        </div >
    )
}
